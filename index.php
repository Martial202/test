...
session_start();
 ...
 include './models/User.php';
    ...
    header('location:rooter.php');
      ...
      if (isset($_POST['btn'])) {
          extract($_POST);
       $user = new User("Admin",$login,$password);
     if($user->auth($login,$password,$cnx)){
        $_SESSION['user'] = $user->auth($login,$password,$cnx);
        header('location:rooter.php');
      } else {
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Authentification</h4>
                            ...
                            <div class="card-body">
                               <form method="POST" class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        <label for="login" class="col-md-12">Nom Utilisateur</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nom Utilisateur"
                                                class="form-control form-control-line" name="login"
                                                id="login">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <a href="rooter.php"><button name="btn" class="btn btn-success text-white">
